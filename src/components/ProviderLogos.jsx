...
const AGENT_PROVIDER = {
  advocate: GoogleLogo,
  critic: OpenAILogo,
  wildcard: AnthropicLogo
}

export function ProviderLogo({ agentId, size = 14 }) {
  const Logo = AGENT_PROVIDER[agentId]
  if (!Logo) return null
